...
copy Envelope.h          %bckdir% > NUL
copy Envelope.cpp        %bckdir% > NUL
copy LFO.h               %bckdir% > NUL
copy LFO.cpp             %bckdir% > NUL
copy Mode.h              %bckdir% > NUL
copy Mode.cpp            %bckdir% > NUL
copy Model.h             %bckdir% > NUL
copy Onboard.h           %bckdir% > NUL
copy Osc.h               %bckdir% > NUL
copy Osc.cpp             %bckdir% > NUL
copy Phonic.h            %bckdir% > NUL
copy Phonic.cpp          %bckdir% > NUL
copy Scroller.h          %bckdir% > NUL
copy Scroller.cpp        %bckdir% > NUL
copy StdEffects.h        %bckdir% > NUL
copy StdEffects.cpp      %bckdir% > NUL
